...
const metrics = [
  { 
    ...
    suffix: "K+", 
    prefix: "+",
    label: "Usuarios activos en chat y voz",
  },
  { 
    value: 99, 
    suffix: ".99%", 
    prefix: "",
    label: "Uptime garantizado (SLA)",
  },
  { 
    value: 24, 
    suffix: "/7", 
    prefix: "",
    label: "Operación ininterrumpida",
  },
  { 
    value: 3, 
    suffix: "x", 
    prefix: "",
    label: "Aumento en citas agendadas",
  },
];
