...
const features = [
  {
    ...
    description: "Lanza campañas telefónicas salientes o recibe llamadas. Tu IA califica leads y agenda citas en piloto automático.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Flujos de Chat Omnicanal",
    description: "WhatsApp (API Oficial), Instagram y Webchat. Detecta la intención de compra y cierra ventas al instante.",
    visual: "ai",
  },
  {
    number: "03",
    title: "E-commerce y Cobros",
    description: "Conecta catálogos nativos y pasarelas como Stripe o PayPal directo en la conversación.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Sincronización Total",
    description: "Extrae datos a Google Sheets, dispara Webhooks y conecta tu CRM favorito en milisegundos.",
    visual: "security",
  },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        const ox = 100 + Math.cos(angle) * radius;
        const oy = 80 + Math.sin(angle) * radius;
        return (
          <g key={i}>
            {/* Connection line */}
            <line
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">en voz y texto.</span>
          </h2>
        </div>
