...
description: "Constructor visual de flujos dentro de la documentación operativa de E-SMART360."
...
- [Variables, etiquetas y segmentación](/docs/chatbots/variables-y-segmentacion)
