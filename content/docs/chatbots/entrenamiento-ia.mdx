---
title: "Entrenamiento de IA con FAQ, URL, archivos y hojas"
description: "Cómo entrenar asistentes con FAQ, URL, archivos, HTTP API y Google Sheets."
