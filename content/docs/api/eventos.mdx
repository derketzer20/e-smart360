---
title: "Eventos"
description: "Eventos dentro de la documentación operativa de E-SMART360."
...
useCase: ["support"]
source: "fulldoc"
canonicalGroup: "api-eventos"
tags: ["api-referencia", "developers", "eventos"]
---

Esta página cubre **Eventos**. La referencia developer documenta cómo conectar eventos, webhooks y payloads con CRM, hojas, ERPs, sitios web y automatizaciones internas. El foco es claridad contractual, seguridad, trazabilidad, retry e idempotencia.
