---
title: "Payloads JSON"
description: "Payloads JSON dentro de la documentación operativa de E-SMART360."
...
useCase: ["support"]
source: "fulldoc"
canonicalGroup: "api-payloads"
tags: ["api-referencia", "developers", "payloads"]
---

Esta página cubre **Payloads JSON**. La referencia developer documenta cómo conectar eventos, webhooks y payloads con CRM, hojas, ERPs, sitios web y automatizaciones internas. El foco es claridad contractual, seguridad, trazabilidad, retry e idempotencia.
