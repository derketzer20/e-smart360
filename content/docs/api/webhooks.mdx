---
title: "Webhooks"
description: "Webhooks dentro de la documentación operativa de E-SMART360."
...
useCase: ["support"]
source: "fulldoc"
canonicalGroup: "api-webhooks"
tags: ["api-referencia", "developers", "webhooks"]
---

Esta página cubre **Webhooks**. La referencia developer documenta cómo conectar eventos, webhooks y payloads con CRM, hojas, ERPs, sitios web y automatizaciones internas. El foco es claridad contractual, seguridad, trazabilidad, retry e idempotencia.
...
- [Seguridad, firma y reintentos](/docs/api/seguridad-y-reintentos)
