---
title: "Llamadas entrantes con voz IA"
description: "Llamadas entrantes con voz IA dentro de la documentación operativa de E-SMART360."
section: "agente-voz"
order: 35
...
useCase: ["support"]
source: "scrape"
canonicalGroup: "agente-voz-llamadas-entrantes"
tags: ["agente-voz", "voice", "agente", "llamadas", "entrantes"]
---

Esta página cubre **Llamadas entrantes con voz IA**. El agente de voz IA cubre llamadas entrantes y salientes para confirmar citas, calificar leads, hacer seguimiento, resolver preguntas frecuentes y escalar a humanos cuando la conversación requiere juicio o sensibilidad.
...
- [Campañas salientes con voz IA](/docs/agente-voz/campanas-salientes)
