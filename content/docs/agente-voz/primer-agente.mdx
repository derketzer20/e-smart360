---
title: "Primer agente de voz IA"
description: "Primer agente de voz IA dentro de la documentación operativa de E-SMART360."
section: "agente-voz"
order: 34
...
useCase: ["support"]
source: "scrape"
canonicalGroup: "agente-voz-primer-agente"
tags: ["agente-voz", "voice", "agente", "primer"]
---

Esta página cubre **Primer agente de voz IA**. El agente de voz IA cubre llamadas entrantes y salientes para confirmar citas, calificar leads, hacer seguimiento, resolver preguntas frecuentes y escalar a humanos cuando la conversación requiere juicio o sensibilidad.
