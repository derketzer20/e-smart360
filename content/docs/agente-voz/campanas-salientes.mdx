---
title: "Campañas salientes con voz IA"
description: "Campañas salientes con voz IA dentro de la documentación operativa de E-SMART360."
section: "agente-voz"
order: 36
...
useCase: ["sales"]
source: "scrape"
canonicalGroup: "agente-voz-campanas-salientes"
tags: ["agente-voz", "voice", "agente", "campanas", "salientes"]
---

Esta página cubre **Campañas salientes con voz IA**. El agente de voz IA cubre llamadas entrantes y salientes para confirmar citas, calificar leads, hacer seguimiento, resolver preguntas frecuentes y escalar a humanos cuando la conversación requiere juicio o sensibilidad.
...
- [Introducción al agente de voz IA](/docs/agente-voz/intro)
- [Primer agente de voz IA](/docs/agente-voz/primer-agente)
- [Llamadas entrantes con voz IA](/docs/agente-voz/llamadas-entrantes)
- [Voz IA para clínicas y citas](/docs/agente-voz/clinicas-y-citas)
