---
title: "Voz IA para clínicas y citas"
description: "Voz IA para clínicas y citas dentro de la documentación operativa de E-SMART360."
section: "agente-voz"
order: 37
...
useCase: ["healthcare"]
source: "scrape"
canonicalGroup: "agente-voz-clinicas-y-citas"
tags: ["agente-voz", "voice", "agente", "clinicas", "citas"]
---

Esta página cubre **Voz IA para clínicas y citas**. El agente de voz IA cubre llamadas entrantes y salientes para confirmar citas, calificar leads, hacer seguimiento, resolver preguntas frecuentes y escalar a humanos cuando la conversación requiere juicio o sensibilidad.
