...
description: "Sector inmobiliario dentro de la documentación operativa de E-SMART360."
section: "sectores"
order: 55
...
useCase: ["real-estate"]
source: "manual"
canonicalGroup: "sectores-inmobiliaria"
tags: ["sectores", "sectors", "inmobiliaria"]
---

Esta página cubre **Sector inmobiliario**. Las guías por sector traducen la suite a problemas reales: ventas, citas, soporte, educación, e-commerce, agencias, inmobiliaria y servicios profesionales. Cada sector combina plataformas distintas y define un camino de adopción progresivo.
