---
title: "Ventas B2B y equipos comerciales"
description: "Ventas B2B y equipos comerciales dentro de la documentación operativa de E-SMART360."
section: "sectores"
order: 53
...
useCase: ["sales"]
source: "manual"
canonicalGroup: "sectores-ventas"
tags: ["sectores", "sectors", "ventas"]
---

Esta página cubre **Ventas B2B y equipos comerciales**. Las guías por sector traducen la suite a problemas reales: ventas, citas, soporte, educación, e-commerce, agencias, inmobiliaria y servicios profesionales. Cada sector combina plataformas distintas y define un camino de adopción progresivo.
...
- [Sector e-commerce](/docs/sectores/ecommerce)
