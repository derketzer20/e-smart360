---
title: "Sector agencias"
description: "Sector agencias dentro de la documentación operativa de E-SMART360."
section: "sectores"
order: 52
...
useCase: ["agency"]
source: "manual"
canonicalGroup: "sectores-agencias"
tags: ["sectores", "sectors", "agencias"]
---

Esta página cubre **Sector agencias**. Las guías por sector traducen la suite a problemas reales: ventas, citas, soporte, educación, e-commerce, agencias, inmobiliaria y servicios profesionales. Cada sector combina plataformas distintas y define un camino de adopción progresivo.
