---
title: "Bots de Telegram y captación"
description: "Bots de Telegram y captación dentro de la documentación operativa de E-SMART360."
section: "telegram"
order: 32
...
useCase: ["support"]
source: "fulldoc"
canonicalGroup: "telegram-bots-y-captacion"
tags: ["telegram", "bots", "captacion"]
---

Esta página cubre **Bots de Telegram y captación**. Telegram complementa WhatsApp cuando se necesitan comunidades, grupos, bots de captación, anti-spam y canales de contenido. Se documenta como parte del ecosistema omnicanal, no como canal separado sin estrategia.
