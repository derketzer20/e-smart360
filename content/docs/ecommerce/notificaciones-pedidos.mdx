...
description: "Notificaciones de pedidos dentro de la documentación operativa de E-SMART360."
section: "ecommerce"
order: 25
...
useCase: ["ecommerce"]
source: "fulldoc"
canonicalGroup: "ecommerce-notificaciones-pedidos"
tags: ["ecommerce", "notificaciones", "pedidos"]
---

Esta página cubre **Notificaciones de pedidos**. En e-commerce conversacional, el chat se vuelve un canal de venta y postventa. El catálogo, los pagos, los pedidos, los carritos abandonados y las notificaciones se conectan para que el cliente compre sin abandonar la conversación y el equipo mantenga trazabilidad.
