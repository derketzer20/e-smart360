---
title: "WooCommerce y pedidos por WhatsApp"
description: "WooCommerce y pedidos por WhatsApp dentro de la documentación operativa de E-SMART360."
section: "ecommerce"
order: 22
...
useCase: ["ecommerce"]
source: "fulldoc"
canonicalGroup: "ecommerce-woocommerce"
tags: ["ecommerce", "woocommerce"]
---

Esta página cubre **WooCommerce y pedidos por WhatsApp**. En e-commerce conversacional, el chat se vuelve un canal de venta y postventa. El catálogo, los pagos, los pedidos, los carritos abandonados y las notificaciones se conectan para que el cliente compre sin abandonar la conversación y el equipo mantenga trazabilidad.
