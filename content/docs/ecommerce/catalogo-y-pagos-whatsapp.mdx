---
title: "Catálogo y pagos por WhatsApp"
description: "Catálogo y pagos por WhatsApp dentro de la documentación operativa de E-SMART360."
section: "ecommerce"
order: 20
...
useCase: ["ecommerce"]
source: "fulldoc"
canonicalGroup: "ecommerce-catalogo-y-pagos-whatsapp"
tags: ["ecommerce", "catalogo", "pagos", "whatsapp"]
---

Esta página cubre **Catálogo y pagos por WhatsApp**. En e-commerce conversacional, el chat se vuelve un canal de venta y postventa. El catálogo, los pagos, los pedidos, los carritos abandonados y las notificaciones se conectan para que el cliente compre sin abandonar la conversación y el equipo mantenga trazabilidad.
...
- [COD, prepago y confirmación de pedidos](/docs/ecommerce/cod-y-prepago)
