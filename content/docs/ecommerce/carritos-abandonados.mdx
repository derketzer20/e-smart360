...
description: "Recuperación de carritos abandonados dentro de la documentación operativa de E-SMART360."
section: "ecommerce"
order: 23
...
useCase: ["ecommerce"]
source: "fulldoc"
canonicalGroup: "ecommerce-carritos-abandonados"
tags: ["ecommerce", "carritos", "abandonados"]
---

Esta página cubre **Recuperación de carritos abandonados**. En e-commerce conversacional, el chat se vuelve un canal de venta y postventa. El catálogo, los pagos, los pedidos, los carritos abandonados y las notificaciones se conectan para que el cliente compre sin abandonar la conversación y el equipo mantenga trazabilidad.
