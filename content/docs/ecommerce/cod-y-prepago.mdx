---
title: "COD, prepago y confirmación de pedidos"
description: "COD, prepago y confirmación de pedidos dentro de la documentación operativa de E-SMART360."
section: "ecommerce"
order: 24
...
useCase: ["ecommerce"]
source: "fulldoc"
canonicalGroup: "ecommerce-cod-y-prepago"
tags: ["ecommerce", "prepago"]
---

Esta página cubre **COD, prepago y confirmación de pedidos**. En e-commerce conversacional, el chat se vuelve un canal de venta y postventa. El catálogo, los pagos, los pedidos, los carritos abandonados y las notificaciones se conectan para que el cliente compre sin abandonar la conversación y el equipo mantenga trazabilidad.
...
- [Catálogo y pagos por WhatsApp](/docs/ecommerce/catalogo-y-pagos-whatsapp)
- [Shopify y automatización conversacional](/docs/ecommerce/shopify)
- [WooCommerce y pedidos por WhatsApp](/docs/ecommerce/woocommerce)
- [Recuperación de carritos abandonados](/docs/ecommerce/carritos-abandonados)
