---
title: "Apps y canales de Oficina Virtual"
description: "Apps y canales de Oficina Virtual dentro de la documentación operativa de E-SMART360."
...
useCase: ["support"]
source: "scrape"
canonicalGroup: "oficina-virtual-apps-y-canales"
tags: ["oficina-virtual", "virtual-office", "oficina", "virtual", "apps", "canales"]
---

Esta página cubre **Apps y canales de Oficina Virtual**. La oficina virtual conecta widget web, página directa, agenda, videollamadas y eventos técnicos. Es útil para clínicas, consultores, servicios profesionales y ventas consultivas que necesitan pasar de interés digital a atención en vivo.
...
- [CNAME, WordPress, Wix y Shopify](/docs/oficina-virtual/cname-y-wordpress-wix-shopify)
