---
title: "Webhooks y API frontend de Oficina Virtual"
description: "Eventos, API frontend y automatización alrededor del widget de atención."
section: "oficina-virtual"
order: 44
audience: ["cliente", "soporte"]
platform: ["virtual-office"]
useCase: ["support"]
source: "scrape"
canonicalGroup: "oficina-virtual-webhooks-y-api-frontend"
tags: ["oficina-virtual", "virtual-office", "oficina", "virtual", "webhooks", "frontend"]
---

Esta página cubre **Webhooks y API frontend de Oficina Virtual**. La oficina virtual conecta widget web, página directa, agenda, videollamadas y eventos técnicos. Es útil para clínicas, consultores, servicios profesionales y ventas consultivas que necesitan pasar de interés digital a atención en vivo.
...
- [Introducción a Oficina Virtual](/docs/oficina-virtual/intro)
- [Widget y página ClickNTalk](/docs/oficina-virtual/widget-y-clickntalk)
- [Agenda y videollamadas](/docs/oficina-virtual/agenda-y-videollamadas)
- [Apps y canales de Oficina Virtual](/docs/oficina-virtual/apps-y-canales)
