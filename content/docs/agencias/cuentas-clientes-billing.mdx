---
title: "Cuentas, clientes y billing"
description: "Cuentas, clientes y billing dentro de la documentación operativa de E-SMART360."
section: "agencias"
order: 62
...
useCase: ["agency"]
source: "fulldoc"
canonicalGroup: "agencias-cuentas-clientes-billing"
tags: ["agencias", "agencies", "cuentas", "clientes", "billing"]
---

Esta página cubre **Cuentas, clientes y billing**. La operación para agencias convierte E-SMART360 en un servicio recurrente: onboarding, cuentas cliente, marca blanca, paquetes, soporte, billing, métricas y expansión mensual.
