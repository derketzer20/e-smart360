---
title: "Fuentes, rebranding y criterio editorial"
description: "Fuentes, rebranding y criterio editorial dentro de la documentación operativa de E-SMART360."
...
useCase: ["support"]
source: "fulldoc"
canonicalGroup: "vision-general-fuentes-y-rebranding"
tags: ["vision-general", "core", "vision", "general", "fuentes", "rebranding"]
---

Esta página cubre **Fuentes, rebranding y criterio editorial**. E-SMART360 organiza esta capacidad como parte de una suite SaaS de automatización comercial para negocios mexicanos y equipos latinos en Estados Unidos. La intención no es mostrar una herramienta aislada, sino explicar cómo se conecta con canales, datos, soporte humano, métricas y operación diaria. Cada implementación debe dejar claro qué resuelve, qué datos necesita, quién la administra y cómo se mide el resultado.
...
- [Visión general de E-SMART360](/docs/overview)
- [Arquitectura del ecosistema](/docs/arquitectura)
- [Onboarding general](/docs/primeros-pasos/onboarding)
- [Soporte y operación diaria](/docs/ayuda/soporte)
