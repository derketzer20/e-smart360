---
title: "Tracking, CRM y formularios"
description: "Tracking, CRM y formularios dentro de la documentación operativa de E-SMART360."
...
useCase: ["support"]
source: "manual"
canonicalGroup: "tarjetas-nfc-tracking-y-crm"
tags: ["tarjetas-nfc", "nfc", "tarjetas", "tracking"]
---

Esta página cubre **Tracking, CRM y formularios**. Las tarjetas digitales NFC convierten el contacto presencial en flujo digital medible. Un perfil, QR o tap NFC puede abrir WhatsApp, agenda, landing, formulario o CRM, y cada interacción debe generar seguimiento.
...
- [Casos de uso de tarjetas NFC](/docs/tarjetas-nfc/casos-de-uso)
