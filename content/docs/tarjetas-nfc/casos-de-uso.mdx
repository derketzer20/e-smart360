---
title: "Casos de uso de tarjetas NFC"
description: "Casos de uso de tarjetas NFC dentro de la documentación operativa de E-SMART360."
...
useCase: ["support"]
source: "manual"
canonicalGroup: "tarjetas-nfc-casos-de-uso"
tags: ["tarjetas-nfc", "nfc", "tarjetas", "casos"]
---

Esta página cubre **Casos de uso de tarjetas NFC**. Las tarjetas digitales NFC convierten el contacto presencial en flujo digital medible. Un perfil, QR o tap NFC puede abrir WhatsApp, agenda, landing, formulario o CRM, y cada interacción debe generar seguimiento.
...
- [Introducción a tarjetas digitales NFC](/docs/tarjetas-nfc/intro)
- [Perfiles, QR y NFC](/docs/tarjetas-nfc/perfiles-y-qr)
- [Tracking, CRM y formularios](/docs/tarjetas-nfc/tracking-y-crm)
