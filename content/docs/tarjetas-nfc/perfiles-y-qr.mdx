---
title: "Perfiles, QR y NFC"
description: "Perfiles, QR y NFC dentro de la documentación operativa de E-SMART360."
...
useCase: ["support"]
source: "manual"
canonicalGroup: "tarjetas-nfc-perfiles-y-qr"
tags: ["tarjetas-nfc", "nfc", "tarjetas", "perfiles"]
---

Esta página cubre **Perfiles, QR y NFC**. Las tarjetas digitales NFC convierten el contacto presencial en flujo digital medible. Un perfil, QR o tap NFC puede abrir WhatsApp, agenda, landing, formulario o CRM, y cada interacción debe generar seguimiento.
